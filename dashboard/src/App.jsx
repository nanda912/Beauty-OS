  ...
  return (
    <div className="rounded-2xl bg-white p-6 shadow-sm border border-brand-pink/20">
      ...
      <p className="mt-2 text-xs text-brand-charcoal/40">
        {approvedPct.toFixed(0)}% conversion rate — your gatekeeper is working
      </p>
    </div>
  )
}
...
function ActivityFeed() {
  const activities = [
    { time: '2 min ago', text: 'Upsell accepted: Nose Wax (+$10)', type: 'revenue' },
    { time: '15 min ago', text: 'Lead filtered: Policy refusal', type: 'filter' },
    { time: '1 hr ago', text: 'Gap filled: Brazilian Wax slot recovered', type: 'gap' },
    { time: '2 hrs ago', text: 'New booking: @sarah_glow — Bikini Wax', type: 'booking' },
    { time: '3 hrs ago', text: 'Upsell sent: Brow Tint suggestion', type: 'revenue' },
  ]

  const typeColors = {
    revenue: 'bg-brand-gold/15 text-brand-gold-dark',
    filter: 'bg-brand-pink-light text-brand-pink-dark',
    gap: 'bg-emerald-50 text-emerald-700',
